...
<form method ="post" action="" enctype="multipart/form-data">
	...
	<table width="794"align ="center" border="1">
	
		<tr align ="center">
		<td colspan= "2"><h1>Update or Edit Products:</h1></td>
		</tr>
		<table>
		<tr>
...
<?php
   ...
   if(isset($_POST['update_product']))
   {
	...
	$product_img3=$_FILES['product_img3']['name'];
		...
		OR $product_desc=='' OR $status=='' OR $product_keywords==''){
