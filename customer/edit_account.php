...
<form action = "" method= "post" enctype= "multipart/form-data">
	...
	<tr>
		...
		<td><img src="customer_photos"/<?php echo $image;?>"width="60" height="60"><br><input type="file" name="c_image" size="60"> </td>
	</tr>
...
if(isset($_POST['update_account']))
{
	...
	if($run_c)
	{
		echo "<script>alart('Your account has been updated!')</script>";
